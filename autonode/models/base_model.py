...
class DBBaseModel(Base):
    ...
    is_deleted = Column(
        Boolean, default=sa.false(), nullable=sa.false(), server_default=sa.false()
    )
    ...
    def from_dict(cls, data):
        """
        Creates a new SQLAlchemy ORM object of the class using the provided dictionary data.

        Args:
            data (dict): A dictionary representing the object with column names as keys and their
